"""
Different decoders for different tasks.
"""
...
class GraphClassification(nn.Module):
    ...
    def __init__(self,
        ...
        self.subgraph_pooling = embedding_model.subgraph_pooling
    ...
    def forward(self,
                data: Data) -> Tensor:
        if self.subgraph_pooling == "SV":
            batch = data.node_idx_batch
        elif self.subgraph_pooling == "VS":
            batch = data.subgraph_idx_batch
        else:
            batch = data.batch
