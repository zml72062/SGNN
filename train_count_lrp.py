...
from datasets.GraphCountDataset import GraphCountDatasetLRP
...
def main():
    ...
    parser.add_argument('--dataset_name', type=str, default="StructureCounting", help='name of dataset')
    ...
    dataset = GraphCountDatasetLRP(path,
